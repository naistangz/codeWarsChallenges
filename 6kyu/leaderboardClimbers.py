...
In this kata you will be given a leaderboard for example:
...
print(leaderboard_sort(['John', 'Brian', 'Jim', 'Dave', 'Fred']),['Dave +1', 'Fred +4', 'Brian -1']) # returns  ['Fred', 'John', 'Dave', 'Brian', 'Jim']